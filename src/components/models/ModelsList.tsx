    ...
    return (
      <Card className="flex flex-col items-center justify-center text-center">
        <CardHeader>
          ...
          <CardDescription>
            You have not trained ant models yet. Start by creating a new model.
          </CardDescription>
          ...
          <CardHeader>
            ...
            <div className="pt-4">
              <Link href={
                ...
                <Button disabled={model.training_status !== "succeeded"} className="w-full group-hover:bg-primary/90">Generate Images <ArrowRight className="ml-2 w-4 h-4"/> </Button>
              </Link>
            </div>
          </CardHeader>
        </Card>
